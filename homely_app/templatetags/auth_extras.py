...
def markdown_format(text):
    md_configs = {
        'homely_app.Markdown.mdx_wikilink_plus:WikiLinkPlusExtension': {
            # all of the above config params are optional
        },
    }
    return mark_safe(markdown.markdown(text, extensions=['extra', 'abbr','homely_app.Markdown.TablesCool:TableExtension','attr_list','def_list','fenced_code','footnotes','homely_app.Markdown.mdx_wikilink_plus:WikiLinkPlusExtension'], extension_configs = md_configs))
